                ...
                <form action="{{ route('invoice.generate') }}" method="POST" class="p-8" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        ...
                        <div>
                            ...
                            <select id="payment_terms" name="payment_terms"
                                    class="w-full border border-slate-200 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all bg-white">
                                <option value="14" {{ old('payment_terms') == '14' ? 'selected' : '' }}>14 dagen</option>
                                <option value="30" {{ old('payment_terms', '30') == '30' ? 'selected' : '' }}>30 dagen</option>
                                <option value="60" {{ old('payment_terms') == '60' ? 'selected' : '' }}>60 dagen</option>
                                <option value="direct" {{ old('payment_terms') == 'direct' ? 'selected' : '' }}>Direct</option>
                            </select>
                        </div>
                    ...
                    <div class="mb-8">
                        ...
                        <textarea id="notes" name="notes" rows="3"
                                  ...
                                  placeholder="Eventuele extra opmerkingen voor de factuur...">{{ old('notes') }}</textarea>
                    </div>
